...
func TestGetAll400(t *testing.T) {
	...
	var jsonStr2 = []byte("{\"offset\":}") //Offset not specified
...
func TestGetOne400(t *testing.T) {
	...
	var jsonStr4 = []byte("{\"id\":1,\"fields\":\"yes\"}") //fields wrong value
...
func TestSetOne400(t *testing.T) {
	var jsonStr1 = []byte("{\"na_me\":\"test2\",\"link\":\"test_link\",\"price\":111222,\"description\":\"testtesttest\"}") //name not specified
	var jsonStr2 = []byte("{\"name\":\"test2\",\"li_nk\":\"test_link\",\"price\":111222,\"description\":\"testtesttest\"}") //link not specified
	var jsonStr3 = []byte("{\"name\":\"test2\",\"link\":\"test_link\",\"pri_ce\":111222,\"description\":\"testtesttest\"}") //price not specified
	var jsonStr4 = []byte("{\"name\":\"test2\",\"link\":\"test_link\",\"price\":111222,\"descr_iption\":\"testtesttest\"}") //description not specified
	var jsonStr5 = []byte("{\"name\":\"test2\",\"link\":\"test_link\",\"price\":-100100,\"descr_iption\":\"testtesttest\"}") //negative price
	var mas [5] *http.Request
	...
	mas[4], _ = http.NewRequest("POST", "/ad/setone", bytes.NewBuffer(jsonStr5))
